...
public class BehaviorCollectionActivity extends Activity implements ActionBar.TabListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_behavior_collection);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.behavior_collection, menu);
        return true;
    }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    return PhysicalActivityFragment.newInstance();
                case 1:
                    return SleepBehaviorFragment.newInstance();
                case 2:
